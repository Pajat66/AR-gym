...
def test_db_connection():
    ...
    for name, config, use_root in configs:
        ...
        try:
            ...
            error_code, error_msg = e.args
            print("FAIL: %s 连接失败: [%d] %s" % (name, error_code, error_msg))
    
    print("\n" + "=" * 50)
    print("FAIL: 所有连接尝试都失败了")
    print("=" * 50)
    print("\n请检查：")
